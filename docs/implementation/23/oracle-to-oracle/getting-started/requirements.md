...
Download file installer OGG 23c dari Oracle:

| File | Keterangan | Link Download |
|---|---|---|
| `fbo_ggs_Linux_x64_Oracle_services_shiphome.zip` | OGG 23c Microservices untuk Oracle | [Oracle Software Delivery Cloud](https://edelivery.oracle.com/) |

!!! info "Cara Download"
    1. Buka [edelivery.oracle.com](https://edelivery.oracle.com/)
    2. Login dengan akun Oracle
    3. Cari **"Oracle GoldenGate"**
    4. Pilih versi **23** untuk platform **Linux x86-64**
    5. Download file `.zip`
...
!!! tip "Tips"
    Verifikasi variabel environment dengan perintah:
    ```bash
    echo $ORACLE_HOME
    echo $ORACLE_SID
    echo $TNS_ADMIN

...
!!! warning "Penting — Trail Name"
    Trail Name harus sama.
...
<div style="text-align: center;">
  <img src="../../../../assets/images/ogg23/replicat-running.png" alt="Replicat Running" style="max-width: 100%; border-radius: 8px; border: 1px solid #ddd;">
</div>
...
<div style="text-align: center;">
  <img src="../../../../assets/images/ogg23/replicat-statistics.png" alt="Replicat Statistics" style="max-width: 100%; border-radius: 8px; border: 1px solid #ddd;">
</div>

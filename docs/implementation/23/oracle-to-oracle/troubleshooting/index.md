...
Kumpulan error yang ditemui selama instalasi dan konfigurasi OGG 23c beserta solusinya.
...
**Solusi:** Tambahkan `INSTALL_OPTION=ORA23c` pada perintah `runInstaller`:
```bash
./runInstaller -silent \

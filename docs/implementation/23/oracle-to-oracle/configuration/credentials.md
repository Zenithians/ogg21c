...
<div style="text-align: center;">
  <img src="../../../../assets/images/ogg23/credential-vm1.png" alt="Credential VM1" style="max-width: 100%; border-radius: 8px; border: 1px solid #ddd;">
</div>
...
<div style="text-align: center;">
  <img src="../../../../assets/images/ogg23/kredensial-vm2.png" alt="Credential VM2" style="max-width: 100%; border-radius: 8px; border: 1px solid #ddd;">
</div>
...
<div style="text-align: center;">
  <img src="../../../../assets/images/ogg23/checkpoint-vm2.png" alt="Checkpoint VM2" style="max-width: 100%; border-radius: 8px; border: 1px solid #ddd;">
</div>

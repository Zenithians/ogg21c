...
## Install OGG Software (Silent Mode)
...
<div style="text-align: center;">
  <img src="../../../../assets/images/ogg23/service-mgr-vm1.jpeg" alt="Service Manager VM1" style="max-width: 100%; border-radius: 8px; border: 1px solid #ddd;">
</div>
...
Tambahkan parameter `INSTALL_OPTION=ORA23c` pada perintah `runInstaller`.
...
Pada OGG 23c Microservices, tidak ada `root.sh`. Cukup jalankan `orainstRoot.sh` saja.

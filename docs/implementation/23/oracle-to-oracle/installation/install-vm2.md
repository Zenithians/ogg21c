...
!!! info "Catatan"
    Proses instalasi OGG di VM2 hampir sama dengan VM1. Perbedaan utama ada pada nama deployment dan direktori.
...
<div style="text-align: center;">
  <img src="../../../../assets/images/ogg23/service-mgr-vm2.png" alt="Service Manager VM2" style="max-width: 100%; border-radius: 8px; border: 1px solid #ddd;">
</div>

!!! success "Instalasi Berhasil"
    Jika deployment **oggtarget** berstatus Running, instalasi OGG di VM2 telah berhasil.

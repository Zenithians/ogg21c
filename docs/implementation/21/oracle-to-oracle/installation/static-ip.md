...
!!! warning "Penting"
    IP statis **wajib** dikonfigurasi agar IP VM tidak berubah saat ganti jaringan/hotspot. Jika IP berubah, konfigurasi TNS dan OGG Distribution Path harus diupdate ulang.

## VM1 (Login sebagai root)
...
!!! tip "Tips"
    Jika `tnsping ORCL` gagal dengan error `TNS-03505: Failed to resolve name`, pastikan tidak ada spasi di awal baris `ORCL =` pada file tnsnames.ora.

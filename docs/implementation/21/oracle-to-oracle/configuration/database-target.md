# Konfigurasi Database Target (VM2)

## Aktifkan Supplemental Logging dan GoldenGate Replication
...
## Grant Privilege ke User GGADMIN
...
## Buat Tabel yang Sama di Target

!!! warning "Penting"
    Struktur tabel di VM2 (Target) **harus sama persis** dengan VM1 (Source).
...
Atau buat manual (jika perlu drop dan buat ulang):
```bash
...
!!! tip "Tips"
    Checkpoint table **harus dibuat via Web GUI OGG**, bukan manual via SQL, agar strukturnya sesuai dengan yang diharapkan OGG.
